...
class DataScene(SearcherABC.SearcherABC):
    ...
    def getTorrentFile(self, url):
        ...
        if re.search("<html", content):
            ...
            if msg:
                self.showMessage('DataScene Login Error', 'Incorrent pair login/password')
            xbmc.sleep(4000)
